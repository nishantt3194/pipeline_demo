...
import {NotificationService} from "./modules/app-common/services/notification.service";
...
export class AppComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        this._authenticationService.is_logged_in.subscribe((is_logged_in) => {
            if (!is_logged_in && this._msalService.instance.getAllAccounts().length > 0) {
                this._authenticationService.refreshUser();
            }
        });
        ...
        // this._coreLoadingScreenService.
    }
